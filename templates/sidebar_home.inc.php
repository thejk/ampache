...
<ul class="sb2" id="sb_home">
    <li><h4 class="header"><span class="sidebar-header-title"><?php echo T_('Browse Music'); ?></span><span class="sprite sprite-icon_all <?php echo isset($_COOKIE['sb_browse']) ? $_COOKIE['sb_browse'] : 'expanded'; ?>" id="browse" lt="<?php echo T_('Expand/Collapse'); ?>" title="<?php echo T_('Expand/Collapse'); ?>"></span></h4>
        <?php
